...
def main(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--confluenceApiToken", required=True, help='e.g. "a87D98AfDsf98dsf7AdsNfaa2"'
    )
    parser.add_argument(
        "--confluenceUrl", required=True, help='e.g. "https://example.jira.com/"'
    )
    parser.add_argument(
        "--confluenceSpace",
        required=True,
    ...
    parser.add_argument(
        "--confluencePageTitlePrefix", required=True, help='e.g. "[MyPrefix] "'
    )
    ...
    parser.add_argument(
        ...
        required=False,
        default=0,
        help="1|0, default=0 (No)." + " Force page update in Confluence",
    )
    parser.add_argument(
        "--forceDelete",
        required=False,
    ...
    parser.add_argument(
        ...
        required=False,
        default=0,
        help="1|0, default=0 (No). Skip page update" + " in Confluence",
    )
